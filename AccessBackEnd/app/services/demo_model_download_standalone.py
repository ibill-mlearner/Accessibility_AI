"""Standalone download probe for ai_pipeline model artifacts.

Run directly:
    python AccessBackEnd/app/services/demo_model_download_standalone.py

Optional model id:
    python AccessBackEnd/app/services/demo_model_download_standalone.py --model-id Qwen/Qwen2.5-0.5B-Instruct
"""
